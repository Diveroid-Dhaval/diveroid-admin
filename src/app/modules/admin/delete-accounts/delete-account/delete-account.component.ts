...
export class DeleteAccountComponent implements OnInit {
    ...
    constructor(
        ...
        this.searchUpdater
            ...
            .subscribe(() => this.getAllDeletedList());
    }
    ...
    private dataInitializer(): void {
        this.initColumns();
        this.getAllDeletedList();
    }

    /**
     * Method to get and set all data to data source     */
    private getAllDeletedList(): void {
        ...
        this.baseService
            .get(Apiurl.deleteAccountList, params)
            .subscribe((response: any) => {
                this.loader.hideLoader();
                if (response) {
                    this.dataSource.data = response.data.deleteAccounts;
    ...
    deleteRecord(id: number) {
        const confirmation = this.dialog.open(CommonDeleteModalComponent, {
            data: {
                title: 'Accounts',
                message:
                    'Are you sure you want to delete this deleted account?',
            },
            width: '30%',
        });
        confirmation.afterClosed().subscribe((dialogResult) => {
            if (dialogResult === true) {
                ...
                this.baseService
                    .delete(Apiurl.deleteAccountList + id)
                    .subscribe(
                        (response: any) => {
                            if (response) {
                                // this.spinnerService.show();
