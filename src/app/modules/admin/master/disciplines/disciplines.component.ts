...
export class DisciplinesComponent implements OnInit {
  ...
  constructor(
      ...
      this.searchUpdater
          ...
          .subscribe(() => this.getAlldisciplineList());
  }
...
-----------------------------------*/
  ...
  getAlldisciplineList() {
      ...
      this.baseService
          .get(Apiurl.disciplinesList, params)
          .subscribe((response: any) => {
              this.loader.hideLoader();
              if (response) {
                  this.dataSource.data = response.data.disciplines;
...
-----------------------------------*/
  ...
  setFormValue(data: any) {
      this.id = data.id;
      this.disciplineForm.controls.Name.setValue(data.Name);
  }
  ...
  saveForm() {
      ...
      if (this.isEdit) {
          this.baseService
              .put(
                  Apiurl.disciplinesList + this.id,
          ...
          this.baseService
              .post(Apiurl.disciplinesList, this.disciplineForm.value)
              .subscribe(
                  (res: any) => {
                      if (res) {
                          this.toastService.showToastMessage(
  ...
  deleteRecord(id: number) {
      ...
      confirmation.afterClosed().subscribe((dialogResult) => {
          if (dialogResult === true) {
              ...
              this.baseService
                  .delete(Apiurl.disciplinesList + id)
                  .subscribe(
                      (response: any) => {
                          if (response) {
                              // this.spinnerService.show();
